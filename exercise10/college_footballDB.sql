...
CREATE TABLE `coaches` (
  ...
  `Yrs_on_Team` int(11) NOT NULL,
  `Winning_Pct` int(11) NOT NULL,
  `Salary` bigint(20) DEFAULT NULL,
  `Bowl_Wins` int(11) NOT NULL,
  `Bowl_Losses` int(11) NOT NULL,
  PRIMARY KEY (`Coach_ID`),
  KEY `Team_ID_idx` (`Team_ID`),
  KEY `Win_idx` (`Winning_Pct`),
  CONSTRAINT `coaches_fk_Team_ID` FOREIGN KEY (`Team_ID`) REFERENCES `teams` (`Team_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `players` (
  ...
  `First_Name` varchar(45) NOT NULL,
  `Last_Name` varchar(45) NOT NULL,
  `Rush_Receive_Rk` int(11) NOT NULL,
  `Rushing_Avg` decimal(10,0) DEFAULT NULL,
  `Rushing_TD` int(11) DEFAULT NULL,
  `Receiving_Avg` decimal(10,0) DEFAULT NULL,
  `Receiving_TD` int(11) DEFAULT NULL,
...
CREATE TABLE `teams` (
  ...
  `Stadium_Size` mediumint(9) NOT NULL,
  `Conference` varchar(45) NOT NULL,
  `Budget` bigint(20) NOT NULL,
  `Record_of_128` int(11) NOT NULL,
  PRIMARY KEY (`Team_ID`),
  KEY `Coach_ID_idx` (`Coach_ID`),
  KEY `Record_idx` (`Record_of_128`),
  CONSTRAINT `teams_fk_Coach_ID` FOREIGN KEY (`Coach_ID`) REFERENCES `coaches` (`Coach_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teams` VALUES ('CLA',10,'UCLA','Rose Bowl',92542,'Pac 12',96000000,85),('GEO',9,'Georgia','Sanford Stadium',92756,'SEC',77000000,42),('LSU',6,'LSU','Tiger Stadium',102321,'SEC',86000000,53),('MIG',1,'Michigan','Big House',107601,'Big Ten',157000000,3),('NEB',7,'Nebraska','Memorial Stadium',90000,'Big Ten',103000000,8),('OHS',3,'Ohio State','Horse Shoe',104944,'Big Ten',145200000,3),('PNS',2,'Penn State','Beaver Stadium',106572,'Big Ten',120000000,8),('TAM',4,'Texas A&M','Kyle Field',102733,'Big 12',109000000,23),('TEN',5,'Tennessee','Neyland Stadium',102455,'SEC',94000000,23),('USC',8,'USC','Coliseum',93607,'Pac 12',105000000,23);
...
-- Dump completed on 2016-11-27  1:43:31
